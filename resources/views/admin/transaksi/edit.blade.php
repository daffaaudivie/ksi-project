...
<x-app-layout>
            ...
            <div class="bg-white shadow-lg sm:rounded-xl overflow-hidden">
                <div class="px-8 py-6 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50">
                    <h2 class="text-2xl font-bold text-gray-900">
                        {{ __('Edit Data Pelanggan') }} - Administrator
                    </h2>
                    <p class="mt-1 text-sm text-gray-500">
                        Perbarui informasi transaksi pelanggan.
                    </p>
                </div>
                        ...
                        <div class="space-y-6">
                            <div class="bg-white p-4 rounded-lg border border-blue-200">
                                <label class="block text-sm font-medium text-blue-900 mb-2">
                                    ...
                                    Lokasi Cabang Transaksi <span class="text-red-500">*</span>
                                </label>
                                <select name="id_cabang" required
                                    class="w-full rounded-lg border-blue-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 bg-white">
                                    <option value="" disabled>Pilih Cabang</option>
                                    @foreach($cabangs as $cabang)
                                    <option value="{{ $cabang->id }}" {{ old('id_cabang', $transaksi->id_cabang) == $cabang->id ? 'selected' : '' }}>
                                        {{ $cabang->nama_cabang }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="tipe_customer" id="tipe_customer" required
                                        ...
                                        <option value="{{ $tipe->value }}" {{ old('tipe_customer', $transaksi->tipe_customer) == $tipe->value ? 'selected' : '' }}>
                                            {{ $tipe->label() }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div id="jumlah_rombongan_container" class="hidden bg-blue-50 p-4 rounded-lg border border-blue-200">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="sumber_informasi" required
                                        ...
                                        <option value="{{ $sumber->value }}" {{ old('sumber_informasi', $transaksi->sumber_informasi) == $sumber->value ? 'selected' : '' }}>
                                            {{ $sumber->label() }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="hidden" name="nama_provinsi" id="nama_provinsi" value="{{ old('nama_provinsi', $transaksi->customer->nama_provinsi ?? '') }}">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="hidden" name="nama_kota" id="nama_kota" value="{{ old('nama_kota', $transaksi->customer->nama_kota ?? '') }}">
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="keterangan" rows="4"
                                        class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition duration-150 ease-in-out"
                                        placeholder="Tulis detail pesanan atau catatan transaksi...">{{ old('keterangan', $transaksi->keterangan) }}</textarea>
                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const savedProvinsiId = "{{ old('id_provinsi', $transaksi->customer->id_provinsi ?? '') }}";
            const savedKotaId = "{{ old('id_kota', $transaksi->customer->id_kota ?? '') }}";
            ...
            fetch(`${BASE_URL_API}/provinces.json`)
                ...
                .then(provinces => {
                    ...
                    provinces.forEach(province => {
                        ...
                        if (province.id == savedProvinsiId) {
                    ...
                    .then(regencies => {
                        ...
                        if (savedKotaId) {
                            ...
                            if (selectedOption && selectedOption.value) {
                                kotaNamaInput.value = selectedOption.text;
                            }
                        }
                    })
                    .catch(error => {
